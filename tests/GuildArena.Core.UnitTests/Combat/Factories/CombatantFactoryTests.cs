...
public class CombatantFactoryTests
{
    ...
    {
        // ARRANGE
        var hero = new HeroCharacter { Id = 100, CharacterDefinitionID = "HERO_TEST", CurrentLevel = 5 };
